...
namespace SlimJim.Test
{
    ...
    {
        [Test]
        [TestCase(@"c:\projects\solutions\packages", @"c:\projects\myproj\src\MyProj\MyProj.csproj",
            @"..\..\..\solutions\packages")]
        public void CalculateRelativePathToSlimjimPackages(string solutionPath, string csProjPath,
