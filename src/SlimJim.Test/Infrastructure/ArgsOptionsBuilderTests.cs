...
namespace SlimJim.Test.Infrastructure
{
	...
	public class ArgsOptionsBuilderTests : TestBase
	{
		...
		public void SpecifiedAdditionalSearchPaths()
		{
			...
			_options = ArgsOptionsBuilder.BuildOptions(new[] { "--search", otherDir, "--search", moreProjects }, WorkingDirectory);
		...
		{
			_options = ArgsOptionsBuilder.BuildOptions(new[] {"--ignore", "Folder1", "--ignore", "Folder2"}, WorkingDirectory);
