...
namespace SlimJim.Test.Model
{
    ...
    public class SlnGenerationOptionsTests : TestBase
    {
        ...
        public void AdditionalSearchPathsRootedAtProjectRoot()
        {
            ...
            Assert.That(_options.AdditionalSearchPaths,
                Is.EqualTo(new[] {Path.Combine(root, path1), Path.Combine(root, path2)}));
        }
        ...
        {
            var slnOutputPath = GetSamplePath("Projects", "Solutions");
